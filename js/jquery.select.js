...
//                  if($this.data("value") == option.val()){
                    if($this.data("value") == option.data("value")){
//                      _html.push("<li class=\"cur\" data-value=\"" + option.val() + "\">" + option.text() + "</li>");
                        _html.push("<li class=\"cur\" data-value=\"" + option.data("value") + "\">" + option.text() + "</li>");
                    }else{
//                      _html.push("<li data-value=\"" + option.val() + "\">" + option.text() + "</li>");
                        _html.push("<li data-value=\"" + option.data("value") + "\">" + option.text() + "</li>");
                    }
                });
                _html.push("</ul>");
                _html.push("</div>");
